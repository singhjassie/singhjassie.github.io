...
}(this, (function (exports, React, jss$1) { 'use strict';
  ...
  */
  ...
  var functionPlugin = function functionPlugin() {
    return {
      onCreateRule: function onCreateRule(name, decl, options) {
        ...
        var rule = jss$1.createRule(name, {}, options);
        rule[fnRuleNs] = decl;
        return rule;
      },
  ...
  var observablePlugin = function observablePlugin(updateOptions) {
    return {
      onCreateRule: function onCreateRule(name, decl, options) {
        ...
        var style$ = decl;
        var rule = jss$1.createRule(name, {}, options); // TODO
  ...
  function () {
    function GlobalContainerRule(key, styles, options) {
      ...
      this.rules = new jss$1.RuleList(_extends({}, options, {
        parent: this
      }));
  ...
  var px = jss$1.hasCSSTOMSupport && CSS ? CSS.px : 'px';
  var ms = jss$1.hasCSSTOMSupport && CSS ? CSS.ms : 'ms';
  var percent = jss$1.hasCSSTOMSupport && CSS ? CSS.percent : '%';
  /**
  ...
  function jssVendorPrefixer() {
    ...
    function prefixStyle(style) {
      for (var prop in style) {
        ...
        var supportedValue$1 = supportedValue(supportedProp, jss$1.toCssValue(value));
    ...
    function onChangeValue(value, prop) {
      return supportedValue(prop, jss$1.toCssValue(value)) || value;
    }
  ...
  var defaultJss = jss$1.create(create());
