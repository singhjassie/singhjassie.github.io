...
const typeData = ['Ethical Hacker', 'Cybersecurity Analyst', 'Flutter Developer']
let index = 0
...
const RunningText = () => {
  ...
  return (
    <Typography className={classes.runningText} variant="h1" align="center" paragraph>
      Hello, I'm <span className={classes.hackers}>Jaskaran Singh</span> <br /><span className={classes.hackers}>{name}</span>
...
const WelcomeSection = () => {
  ...
  return (
    ...
    >
      ...
      Passionate and dedicated cybersecurity enthusiast with a strong foundation in Linux, networking, and programming. Committed to continuous learning and leveraging technical skills to address evolving cyber threats. Seeking opportunities to contribute to innovative cybersecurity projects and make a positive impact in the field.
      </Typography>
